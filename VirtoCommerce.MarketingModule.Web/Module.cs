...
namespace VirtoCommerce.MarketingModule.Web
{
    ...
    {
        private readonly string _connectionStringName = ConfigurationHelper.GetConnectionStringValue("VirtoCommerce.Marketing") ?? ConfigurationHelper.GetConnectionStringValue("VirtoCommerce");
