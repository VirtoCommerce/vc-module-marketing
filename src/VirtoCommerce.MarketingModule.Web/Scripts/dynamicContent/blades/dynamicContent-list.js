...
.controller('virtoCommerce.marketingModule.dynamicContentListController', ['$scope', 'platformWebApp.bladeNavigationService', function ($scope, bladeNavigationService) {
    ...
    function initializeBlade() {
        var entities = [
            { id: 'DC_2', name: 'marketing.blades.placeholders.list.title', subname: 'marketing.blades.placeholders.list.subtitle', title: 'marketing.blades.dynamicContent-list.menu.placeholders.title', description: 'marketing.blades.dynamicContent-list.menu.placeholders.description', icon: 'fa-object-group', entityName: 'placeholders' },
            ...
            { id: 'DC_3', name: 'marketing.blades.publishing.list.title', subname: 'marketing.blades.publishing.list.subtitle', title: 'marketing.blades.dynamicContent-list.menu.publishing.title', description: 'marketing.blades.dynamicContent-list.menu.publishing.description', icon: 'fa-calendar-check-o', entityName: 'publishing' }];
