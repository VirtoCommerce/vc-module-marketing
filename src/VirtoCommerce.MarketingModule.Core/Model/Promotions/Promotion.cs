...
public class Promotion : AuditableEntity, ICloneable
{
    ...
    public virtual Task<IList<PromotionReward>> EvaluatePromotionAsync(IEvaluationContext context)
    {
        return Task.FromResult<IList<PromotionReward>>(Array.Empty<PromotionReward>());
    }

    public virtual object Clone()
    {
        return (Promotion)MemberwiseClone();
    }
}
