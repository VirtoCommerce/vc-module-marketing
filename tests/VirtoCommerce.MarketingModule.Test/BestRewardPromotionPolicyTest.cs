...
{
    private const string _promoGet_10_off = "Get 10% off on ProductA";
    private const string _promoGet_15_offFor1of2 = "Get 15% off for every 1 of 2 on ProductA";
    private const string _promoGet_25_offFor1of2 = "Get 25% off for every 1 of 2 on ProductA";
    ...
    [Theory]
    [InlineData(1, 10, _promoGet_10_off, _promoGet_15_offFor1of2)]
    [InlineData(2, 10, _promoGet_10_off, _promoGet_15_offFor1of2)]
    [InlineData(2, 25, _promoGet_10_off, _promoGet_15_offFor1of2, _promoGet_25_offFor1of2)]
    [InlineData(2, 15, _promoGet_15_offFor1of2)]
    [InlineData(2, 25, _promoGet_15_offFor1of2, _promoGet_25_offFor1of2)]
    [InlineData(3, 10, _promoGet_10_off, _promoGet_25_offFor1of2)]
    [InlineData(4, 25, _promoGet_10_off, _promoGet_25_offFor1of2)]
    [InlineData(7, 25, _promoGet_10_off, _promoGet_25_offFor1of2)]
    ...
    public async Task EvaluatePaymentCondition_AcceptablePaymentType()
    {
        ...
        var evalPolicy = GetPromotionEvaluationPolicy([promotion]);
        var productA = new ProductPromoEntry { ProductId = "ProductA", Price = 100, Quantity = 1 };
    ...
    public async Task EvaluatePromotion_GetBestPaymentReward()
    {
        ...
        var evalPolicy = GetPromotionEvaluationPolicy([dynamicPromotion]);
        var productA = new ProductPromoEntry { ProductId = "ProductA", Price = 100, Quantity = 1 };
        var context = new PromotionEvaluationContext
        {
    ...
    public async Task ChooseTheBestExclusivePromotion()
    {
        ...
        var evalPolicy = GetPromotionEvaluationPolicy([exclusivePromotion, ordinalPromotion]);
        var productA = new ProductPromoEntry { ProductId = "ProductA", Price = 100, Quantity = 1 };
        var context = new PromotionEvaluationContext
        {
    ...
    private static IMarketingPromoEvaluator GetPromotionEvaluationPolicy(IEnumerable<Promotion> promotions)
    {
        ...
        promoSearchServiceMock.Setup(x => x.SearchAsync(It.IsAny<PromotionSearchCriteria>(), It.IsAny<bool>())).ReturnsAsync(result);
