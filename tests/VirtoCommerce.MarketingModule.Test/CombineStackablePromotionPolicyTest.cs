...
public class CombineStackablePromotionPolicyTest
{
    ...
    public async Task EvaluateRewards_CombineByPriorityOrder()
    {
        ...
        var context = new PromotionEvaluationContext
        {
            ...
            PromoEntries = [productA, productB],
        };
        // Act
    ...
    {
        // Arrange 
        var evalPolicy = GetPromotionEvaluationPolicy([new BuyProductWithTagPromotion(["tag1"], 10)]);
    ...
    public async Task EvaluateRewards_DynamicPromotions()
    {
        ...
        var context = new PromotionEvaluationContext
        {
            ...
            IsEveryone = true,
            PromoEntries = [new ProductPromoEntry { ProductId = "1" }],
            CartPromoEntries = [new ProductPromoEntry { Quantity = 11, Price = 5 }],
        };
    ...
    public async Task ChooseTheFirstExclusivePromotions()
    {
        ...
        var evalPolicy = GetPromotionEvaluationPolicy([firstPromotion, secondPromotion]);
        var productA = new ProductPromoEntry { ProductId = "ProductA", Price = 100, Quantity = 1 };
        var context = new PromotionEvaluationContext
        {
...
{
    public IList<PromotionReward> Rewards { get; set; }
