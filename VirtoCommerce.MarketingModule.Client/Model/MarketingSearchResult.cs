...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketingSearchResult :  IEquatable<MarketingSearchResult>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketingSearchResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarketingSearchResult);
        }

        /// <summary>
        /// Returns true if MarketingSearchResult instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketingSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketingSearchResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
