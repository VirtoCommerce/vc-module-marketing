...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PromotionReward :  IEquatable<PromotionReward>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PromotionReward {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PromotionReward);
        }

        /// <summary>
        /// Returns true if PromotionReward instances are equal
        /// </summary>
        /// <param name="other">Instance of PromotionReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PromotionReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
