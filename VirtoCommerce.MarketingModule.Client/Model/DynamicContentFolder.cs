...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicContentFolder :  IEquatable<DynamicContentFolder>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicContentFolder {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicContentFolder);
        }

        /// <summary>
        /// Returns true if DynamicContentFolder instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicContentFolder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicContentFolder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
