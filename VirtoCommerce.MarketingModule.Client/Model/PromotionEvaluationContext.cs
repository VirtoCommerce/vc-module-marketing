...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PromotionEvaluationContext :  IEquatable<PromotionEvaluationContext>
    {
        /// <summary>
        ...
        public List<ProductPromoEntry> CartPromoEntries { get; set; }

        /// <summary>
        /// Gets or Sets PromoEntries
        /// </summary>
        [DataMember(Name="promoEntries", EmitDefaultValue=false)]
        public List<ProductPromoEntry> PromoEntries { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PromotionEvaluationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PromotionEvaluationContext);
        }

        /// <summary>
        /// Returns true if PromotionEvaluationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of PromotionEvaluationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PromotionEvaluationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
