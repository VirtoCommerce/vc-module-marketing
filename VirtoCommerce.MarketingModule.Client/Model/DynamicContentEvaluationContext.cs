...
{
    /// <summary>
    /// DynamicContentEvaluationContext
    /// </summary>
    [DataContract]
    public partial class DynamicContentEvaluationContext :  IEquatable<DynamicContentEvaluationContext>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicContentEvaluationContext {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicContentEvaluationContext);
        }

        /// <summary>
        /// Returns true if DynamicContentEvaluationContext instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicContentEvaluationContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicContentEvaluationContext other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
