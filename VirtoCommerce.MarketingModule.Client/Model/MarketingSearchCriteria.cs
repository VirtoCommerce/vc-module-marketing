...
{
    /// <summary>
    /// MarketingSearchCriteria
    /// </summary>
    [DataContract]
    public partial class MarketingSearchCriteria :  IEquatable<MarketingSearchCriteria>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketingSearchCriteria {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarketingSearchCriteria);
        }

        /// <summary>
        /// Returns true if MarketingSearchCriteria instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketingSearchCriteria to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketingSearchCriteria other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
