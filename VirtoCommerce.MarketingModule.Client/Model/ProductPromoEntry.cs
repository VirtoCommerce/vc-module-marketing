...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductPromoEntry :  IEquatable<ProductPromoEntry>
    {
        /// <summary>
        /// Gets or Sets Code
        /// </summary>
        ...
        public List<ProductPromoEntry> Variations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductPromoEntry {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProductPromoEntry);
        }

        /// <summary>
        /// Returns true if ProductPromoEntry instances are equal
        /// </summary>
        /// <param name="other">Instance of ProductPromoEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductPromoEntry other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
