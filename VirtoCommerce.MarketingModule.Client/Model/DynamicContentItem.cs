...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicContentItem :  IEquatable<DynamicContentItem>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicContentItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicContentItem);
        }

        /// <summary>
        /// Returns true if DynamicContentItem instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicContentItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicContentItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
