...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicContentPlace :  IEquatable<DynamicContentPlace>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicContentPlace {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicContentPlace);
        }

        /// <summary>
        /// Returns true if DynamicContentPlace instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicContentPlace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicContentPlace other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
