...
namespace VirtoCommerce.MarketingModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DynamicContentPublication :  IEquatable<DynamicContentPublication>
    {
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicContentPublication {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DynamicContentPublication);
        }

        /// <summary>
        /// Returns true if DynamicContentPublication instances are equal
        /// </summary>
        /// <param name="other">Instance of DynamicContentPublication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicContentPublication other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
